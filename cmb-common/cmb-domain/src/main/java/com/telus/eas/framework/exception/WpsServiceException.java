...
public class WpsServiceException extends TelusSystemException {
	 ...
	 */
	public ServiceFaultInfo getWpsServiceFaultInfo() {
		return wpsServiceFaultInfo;
	}
