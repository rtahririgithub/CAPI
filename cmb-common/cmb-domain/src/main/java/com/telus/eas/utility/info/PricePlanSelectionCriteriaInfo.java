...
public class PricePlanSelectionCriteriaInfo extends Info {
	...
	private String[] socGroups;
	private OfferCriteriaInfo offerCriteria;

	public PricePlanSelectionCriteriaInfo() {
	...
	/**
	 * @param socGroups the socGroups to set
	 */
	public void setSocGroups(String[] socGroups) {
		this.socGroups = socGroups;
	}

	/**
	 * @return the list of offerCriteriaInfo
	 */
	public OfferCriteriaInfo getOfferCriteria() {
		return offerCriteria;
	}

	/**
	 * @param offerCriteriaInfo the offerCriteriaInfo to set
	 */
	public void setOfferCriteria(OfferCriteriaInfo offerCriteria) {
	...
	public String toString() {
		...
		buffer.append("PricePlanSelectionCriteriaInfo [productType=")
		.append(productType)
		...
		.append(productPromoTypes != null ? 
				Arrays.asList(productPromoTypes) : null)
		.append(", socGroups=")
		.append(socGroups != null ? 
				Arrays.asList(socGroups) : null)		
		.append(", initialActivation=")
		.append(initialActivation)
		.append(", includeFeaturesAndServices=")
		.append(includeFeaturesAndServices)
		.append(", offerCriteria=")
		.append(offerCriteria)
		.append("]");
