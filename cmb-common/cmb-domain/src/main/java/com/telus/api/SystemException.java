...
public class SystemException extends RuntimeException {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4187269522520880754L;
	...
	public SystemException(String systemCode, String errorMessage, String errorMessageFr) {
		super(errorMessage);
		this.systemCode = systemCode;
		this.errorMessage = errorMessage;
		this.errorMessageFr = errorMessageFr;
	}
	public SystemException(String systemCode, String errorCode, String errorMessage, String errorMessageFr) {
		super(errorMessage);
	...
	public SystemException(String systemCode, String errorMessage, String errorMessageFr, Throwable t) {
		super(errorMessage);
		this.systemCode = systemCode;
		this.errorMessage = errorMessage;
		this.errorMessageFr = errorMessageFr;
	...
	public SystemException(String systemCode, String errorCode, String errorMessage, String errorMessageFr,
			ApplicationException nestedException) {
		super(errorMessage);
		this.errorCode = errorCode;
		this.systemCode = systemCode;
		this.errorMessage = errorMessage;
	...
	public SystemException(String systemCode, String errorMessage, String errorMessageFr, 
	 ...
	 private String constructMessage() {
		 ...
		 if (	(this.systemCode != null && this.systemCode.length() > 0) ||
				 ...
				 (this.errorMessageFr != null && this.errorMessageFr.length() > 0) ||
			 	 (this.errorCode != null && this.errorCode.length() > 0)) {
			 sb.append("System\n");
			 sb.append("------\n");
		 }
		 if (this.systemCode != null && this.systemCode.length() > 0) {
