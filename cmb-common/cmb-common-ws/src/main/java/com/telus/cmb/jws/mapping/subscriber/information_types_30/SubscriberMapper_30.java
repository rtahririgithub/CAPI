...
public class SubscriberMapper_30 extends AbstractSchemaMapper<Subscriber, SubscriberInfo> {
	private static SubscriberMapper_30 INSTANCE = null;

	private SubscriberMapper_30() {
		super (Subscriber.class, SubscriberInfo.class);
	}
	
	public synchronized static SubscriberMapper_30 getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new SubscriberMapper_30();
		}
	...
	protected SubscriberInfo performDomainMapping(Subscriber source, SubscriberInfo target) {
		...
		target.setActivityCode(source.getActivityCd());
		target.setActivityReasonCode(source.getActivityReasonCd());
