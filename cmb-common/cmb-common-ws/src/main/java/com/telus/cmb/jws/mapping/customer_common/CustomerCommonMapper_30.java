package com.telus.cmb.jws.mapping.customer_common;
...
public class CustomerCommonMapper_30 {
	public static AddressMapper AddressMapper() {
		return AddressMapper.getInstance();
	}
	
	public static class AddressMapper extends AbstractSchemaMapper<Address, EnterpriseAddressInfo> {
		...
		protected Address performSchemaMapping(EnterpriseAddressInfo source, Address target) {
			...
			if(source.getAdditionalAddressInformation()!= null) {
				target.getAdditionalAddressInformation().addAll(source.getAdditionalAddressInformation());
			}
			...
			if(source.getRenderedAddress() != null) {
				target.getRenderedAddress().addAll(source.getRenderedAddress());
			}
		...
		protected EnterpriseAddressInfo performDomainMapping(Address source, EnterpriseAddressInfo target) {
			...
			if(source.getAdditionalAddressInformation()!= null) {
				target.setAdditionalAddressInformation(Arrays.asList(source.getAdditionalAddressInformation()));
			}
			...
			if(source.getRenderedAddress() != null) {
				target.setRenderedAddress(Arrays.asList(source.getRenderedAddress()));
			}
			if(source.getRuralRouteNumber() != null) {
				target.setRuralRouteNumber(source.getRuralRouteNumber());
			}
