...
@UseTestDataFrom(value= "cmb/regression/activation/testdata-PostpaidBusinessSubscriberActivation-$DATADIR.csv")
@WithTagValuesOf({"epic: Regression", "test type: web service", "test style: structured (recommended)"})
public class BusinessSubscriberActivationTest extends WebServiceBaseTest {
	...
	@Test
	public void testSubscriberActivationForBusinessAccounts() throws Exception {
		reservePhoneNumber();
		activateSubscriber();
		cancelSubscriber();
	}
	...
	@Test
	public void testReservePhoneNumberForBusinessAccounts() throws Exception {		
		reservePhoneNumber();
		releasePhoneNumber();
	}
