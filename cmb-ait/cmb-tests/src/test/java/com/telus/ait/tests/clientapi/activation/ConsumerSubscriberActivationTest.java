...
@UseTestDataFrom(value= "cmb/regression/activation/testdata-PostpaidConsumerSubscriberActivation-$DATADIR.csv")
@WithTagValuesOf({"epic: Regression", "test type: web service", "test style: structured (recommended)"})
public class ConsumerSubscriberActivationTest extends WebServiceBaseTest {
	...
	@Test
	public void testSubscriberActivationForConsumerAccounts() throws Exception {
		reservePhoneNumber();
		activateSubscriber();
		cancelSubscriber();
	}
	...
	@Test
	public void testReservePhoneNumberForConsumerAccounts() throws Exception {		
		reservePhoneNumber();
		releasePhoneNumber();
	}
