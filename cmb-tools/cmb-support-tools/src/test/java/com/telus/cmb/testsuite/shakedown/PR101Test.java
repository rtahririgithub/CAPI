...
public class PR101Test extends EnvBaseTest {

	static {
		String ldapUrl = "ldaps://ldapread-p.tmi.telus.com:636/cn=prod_81,o=telusconfiguration";
	...
	protected String[] getClusters(String group, String[] defaultClusters) {
		...
		} else if (Constants.GROUP_UTILITY_EJB.equals(group)) {
