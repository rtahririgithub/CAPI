			...
			<div class="ui grid">
				...
				<div class="four wide middle aligned column">
					<div class='ui fluid green selection dropdown'>
						...
						<div class='default text'>Select a log server...</div>				
						<i class='dropdown icon'></i>
						<div class='menu'>						
							<c:forEach items="${logServers}" var="logServer" varStatus="status">
								<a href="${readURL}/${logServer.shortname}" class='item'>${logServer.name} (${logServer.host})</a>
							</c:forEach>					
						</div>
					</div>
				</div>
