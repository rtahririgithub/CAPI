...
public interface SubscriberDao {
	...
	List<ResourceInfo> retrieveSeatResourceInfoByBanAndPhoneNumber(Connection connection, int ban, String phoneNumber, boolean includeCancelled) throws ApplicationException;
	...
	Collection<SubscriberInfo> retrieveSubscriberListByPhoneNumber(String phoneNumber,int maximum,boolean includeCancelled) throws ApplicationException;
	Collection<SubscriberInfo> retrieveSubscriberListByPhoneNumbers(List<String> phoneNumberList,int maximum,boolean includeCancelled) throws ApplicationException ;
	Collection<SubscriberInfo> retrieveSubscriberListBySubscriberId(String subscriberId,boolean includeCancelled,int maximum) throws ApplicationException ;
	Collection<SubscriberInfo> retrieveSubscriberListByBanAndSubscriberId(int ban,String subscriberId,boolean includeCancelled,int maximum) throws ApplicationException;

	/**
	 *
	 * @param ban can be optional  , set to 'zero' to retrieve the subscriberList by only seatResourceNumber.
	 * @param seatResourceNumber - mandatory
	 * @param maximum - set to zero to get maximum threshold subscriber list  based on ldap configuration value.
	 * @param includeCancelled - false/true
	 * @return
	 * @throws ApplicationException
	 */
	Collection<SubscriberInfo> retrieveSubscriberListByBanAndSeatResourceNumber(int ban,String seatResourceNumber,int maximum, boolean includeCancelled) throws ApplicationException ;
}
