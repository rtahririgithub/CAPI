...
--------------------------------------------------
  ...
  -- relation_type                   VARCHAR2 (1),
   equiv_service_exists            VARCHAR2 (1),
--------------------------------------------------
   period_set_code                 VARCHAR2 (4),
   loyalty_and_retention_service   VARCHAR2 (1),
...
--------------------------------------------------
   ...
   mp_ind                          VARCHAR2 (1),
   duration                        NUMBER (3, 0),
   lbs_tracker                      VARCHAR2 (1),
   lbs_trackee                      VARCHAR2 (1),
...
--------------------------------------------------
   ...
   promo_validation_eligible      VARCHAR2 (1),
