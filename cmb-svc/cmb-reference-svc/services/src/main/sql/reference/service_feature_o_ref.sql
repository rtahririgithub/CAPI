-- SCHEMA: AMDOCS_EXTO_REF
-- For WOME April 2015, update family_type to VARCHAR2(2)
-- April 2019 - change soc_description length to 100
...
CREATE OR REPLACE TYPE service_feature_o AS OBJECT (
   ...
   soc                             VARCHAR2 (9),
   soc_description                 VARCHAR2 (100),
   soc_description_f               VARCHAR2 (100),
