...
--E1  
UPDATE adapted_message
  SET message_text = 'The client''s request can not be completed because this device''s phone number cannot be activated on the selected network. Please select a phone number from a different NPA-NXX to activate this device on the TELUS network or contact your TELUS Support Team for additional assistance. (RC E1)', update_dt=sysdate, user_last_modify=user
  WHERE application_message_id=92  AND adapted_message_seq = 1;
UPDATE adapted_message
  SET message_text = 'Impossible de traiter la demande du client, car le numéro de téléphone de cet appareil ne peut pas être activé sur le réseau sélectionné. Veuillez choisir un numéro de téléphone avec un NPA-NXX différent pour activer l’appareil sur le réseau de TELUS ou communiquez avec votre équipe de soutien TELUS pour obtenir de l’aide. (RC E1)', update_dt=sysdate, user_last_modify=user
  WHERE application_message_id=92  AND adapted_message_seq = 2;
UPDATE adapted_message
  SET message_text = 'This phone number cannot be activated on the selected network. Please select a phone number from a different NPA-NXX to continue or contact your Koodo Support Team for assistance. (RC E1)', update_dt=sysdate, user_last_modify=user
  WHERE application_message_id=92  AND adapted_message_seq = 3;
UPDATE adapted_message
  SET message_text = 'Ce numéro de téléphone ne peut pas être activé sur le réseau sélectionné. Veuillez choisir un numéro de téléphone avec un NPA-NXX différent pour continuer ou communiquez avec votre équipe du service à la clientèle de Koodo pour obtenir de l’aide. (RC E1)', update_dt=sysdate, user_last_modify=user
...
UPDATE adapted_message
  SET message_text = 'Ce numéro de téléphone ne peut pas être activé sur le réseau sélectionné. Veuillez choisir un numéro de téléphone avec un NPA-NXX différent pour continuer ou communiquez avec votre équipe du service à la clientèle de Koodo pour obtenir de l''aide. (RC E3)', update_dt=sysdate, user_last_modify=user
  WHERE application_message_id=94  AND adapted_message_seq = 2;
UPDATE adapted_message
  SET message_text = 'This phone number cannot be activated on the selected network. Please select a phone number from a different NPA-NXX to continue or contact your Koodo Support Team for assistance. (RC E3)', update_dt=sysdate, user_last_modify=user
...
UPDATE adapted_message
  SET message_text = 'The customer''s request to move to Koodo Mobile is in progress. Advise the customer that we will notify them of any changes to the status of the request. (RC E9)', update_dt=sysdate, user_last_modify=user
  WHERE application_message_id=100  AND adapted_message_seq = 3;
UPDATE adapted_message
  SET message_text = 'La demande de transfert du client au réseau de Koodo Mobile est en cours de traitement. Veuillez informer le client que nous l''aviserons de tout changement à l''état de sa demande. (RC E9)', update_dt=sysdate, user_last_modify=user
