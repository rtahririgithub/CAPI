...
public class CreditCheckResultUpdateHandler implements MessageHandlerList<List<Object>>{
	...
	public void handle(List<Object> messageList, ClientIdentity clientIdentity,
		...
		accountLifecycleManager.updateCreditCheckResult(
				Integer.parseInt(messageList.get(1).toString()), 
				(String)messageList.get(2), 
				(CreditCheckResultDepositInfo[])messageList.get(3), 
				(String)messageList.get(4), 
