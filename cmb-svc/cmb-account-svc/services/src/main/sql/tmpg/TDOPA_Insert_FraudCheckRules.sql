...
/*******************************************************************************************************************************
 WPS Fraud Rules setup for Online PrePaid Activations  Application (TDOPA_1)
 Note : We are not creating new application groupId /payment rule for TDOPA_1 on boarding ,instead using SELF_SERVE existing payment rule id .
/********************************************************************************************************************************/
...
VALUES (
(SELECT Max(APP_ID)+1 from APPLICATION),'TDOPA_1',
(SELECT APP_GROUP_ID from APPLICATION_GROUP WHERE APP_GROUP_CD = 'SELF_SERVE'),
'Online PrePaid Activations', 'Online PrePaid Activations', SYSDATE, SYSDATE, 'SYSTEM');
...
(select APP_ID from APPLICATION where APP_CD = 'TDOPA_1'),
...
UPDATE FRAUD_CONFIG
SET FRAUD_CONFIG_TXT=CONCAT('TDOPA,',FRAUD_CONFIG_TXT)
WHERE
