...
Begin
     ...
     select  bf.ban, bf.urban_id, bf.fleet_id, bf.exp_no_of_sub, bf.exp_no_of_tg, ui.fleet_alias,
            ...
            (select ban from ban_fleet bf2 where bf.urban_id = bf2.urban_id and
              bf.fleet_id = bf2.fleet_id and bf2.owner_ind = 'Y' and bf2.exp_date is null) owner
     from    ban_fleet bf, uf_inv ui
     where   bf.ban = pi_ban
...
Is
 Begin
     ...
     select ui.urban_id, ui.fleet_id, ui.fleet_alias, ui.fleet_type, nvl(ui.exp_no_of_ufmi,0), nvl(ui.exp_no_of_tg,0),
            bf.ban, ui.n_dap_id, ui.ufmi_counter, ui.dap_number
    from uf_inv ui, ban_fleet bf
...
Is
 Begin
     ...
     from uf_inv ui, ban_fleet bf , fleet_class fc, market_npa_nxx_lr m
