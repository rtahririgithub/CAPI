...
-- 2017-12-05	Emerson Cho		2018.04		Removed hint from getLwSubsByBan per DBA (Anar) advice
-- May 29, 2018 Tsz Chung Tong  2018.07.1   Removed unused stored procedures
--------------------------------------------------------------------------------------------------------------------------------------------------------
...
-- absolute maximum for the number of accounts to be retrieved
   ...
   version_no          	   CONSTANT VARCHAR2(10)       := '2018.07.1';
