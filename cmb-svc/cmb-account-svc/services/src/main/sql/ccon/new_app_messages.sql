...
INSERT INTO APP_MESSAGES ( APP_ROLE_ID, RESPONSE_CODE, RESPONSE_MESSAGE_EN, RESPONSE_MESSAGE_FR, RESPONSE_KB ) 
						VALUES ( 'AMDOCS_CLIENT', '100', 
								...
								'Désolés, votre paiement par carte de crédit ne peut pas être effectué. Veuillez vérifier les renseignements sur la carte de crédit et essayez de nouveau. Si le problème persiste, veuillez communiquer avec votre institution financière.', 
...
INSERT INTO APP_MESSAGES ( APP_ROLE_ID, RESPONSE_CODE, RESPONSE_MESSAGE_EN, RESPONSE_MESSAGE_FR, RESPONSE_KB ) 
						VALUES ( 'AMDOCS_CLIENT', '101', 
								...
								'Désolés, votre paiement par carte de crédit ne peut pas être effectué. Veuillez vérifier les renseignements sur la carte de crédit. Si le problème persiste, veuillez communiquer avec le service à la clientèle en composant le 611.', 
								'Transaction failure. Credit card listed in negative database. Use Source form to send details to Loss Prevention.'); 
...
INSERT INTO APP_MESSAGES ( APP_ROLE_ID, RESPONSE_CODE, RESPONSE_MESSAGE_EN, RESPONSE_MESSAGE_FR, RESPONSE_KB ) 
						VALUES ( 'AMDOCS_CLIENT', '300', 
								...
								'Votre paiement par carte de crédit ne peut pas être effectué tel que demandé. Veuillez vérifier les renseignements sur la carte de crédit et essayez de nouveau. Si le problème persiste, veuillez communiquer avec le service à la clientèle en composant le 611.', 
...
INSERT INTO APP_MESSAGES ( APP_ROLE_ID, RESPONSE_CODE, RESPONSE_MESSAGE_EN, RESPONSE_MESSAGE_FR, RESPONSE_KB ) 
						VALUES ( 'AMDOCS_DEALER', '100', 
								'Sorry, we cannot process your credit card payment.  Please verify the credit card details you provided and try again.  If the problem persists, please contact your financial institution.', 
								'Désolés, le paiement par carte de crédit ne peut pas être effectué. Veuillez vérifier les renseignements sur la carte de crédit et essayez de nouveau. Si le problème persiste, veuillez communiquer avec votre institution financière. ', 
								'Transaction failure. Credit card declined by financial institution. Client should contact financial institution.'); 
...
INSERT INTO APP_MESSAGES ( APP_ROLE_ID, RESPONSE_CODE, RESPONSE_MESSAGE_EN, RESPONSE_MESSAGE_FR, RESPONSE_KB ) 
						VALUES ( 'AMDOCS_DEALER', '101', 
								...
								'Désolés, votre paiement par carte de crédit ne peut pas être effectué. Veuillez vérifier les renseignements sur la carte de crédit. Si ces renseignements sont exacts, veuillez communiquer avec le service à la clientèle.', 
								'Transaction failure. Credit card listed in negative database. Use Source form to send details to Loss Prevention.'); 
...
INSERT INTO APP_MESSAGES ( APP_ROLE_ID, RESPONSE_CODE, RESPONSE_MESSAGE_EN, RESPONSE_MESSAGE_FR, RESPONSE_KB ) 
						VALUES ( 'AMDOCS_DEALER', '102', 
								...
								'Désolés, le paiement par carte de crédit ne peut pas être effectué. Veuillez vérifier le numéro et la date d''expiration de la carte de crédit. S''il s''agit d''une carte de crédit internationale, vous aurez peut-être à la préenregistrer. Si le problème persiste, veuillez communiquer avec le service à la clientèle en composant le 611.', 
								'Transaction failure. International credit card. Client must pre-register credit card w/Loss Prevention or use Canadian credit card.'); 
...
INSERT INTO APP_MESSAGES ( APP_ROLE_ID, RESPONSE_CODE, RESPONSE_MESSAGE_EN, RESPONSE_MESSAGE_FR, RESPONSE_KB ) 
						VALUES ( 'AMDOCS_DEALER', '300', 
								...
								'Désolés, le paiement par carte de crédit ne peut pas être effectué. Veuillez vérifier les renseignements sur la carte de crédit et essayez de nouveau. Si vous obtenez encore ce message, veuillez communiquer avec le service à la clientèle.', 
								'Transaction failure.  AVS Mismatch. Billing address provided by client must match address on file with credit bureau.'); 

INSERT INTO APP_MESSAGES ( APP_ROLE_ID, RESPONSE_CODE, RESPONSE_MESSAGE_EN, RESPONSE_MESSAGE_FR, RESPONSE_KB ) 
						VALUES ( 'AMDOCS_AGENT', '100', 
								'Sorry, we cannot process your credit card payment.  Please verify the credit card details you provided and try again.  If the problem persists, please contact your financial institution.', 
								'Le paiement par carte de crédit ne peut pas être effectué. Veuillez vérifier les renseignements sur la carte de crédit et essayez de nouveau. Si le problème persiste, veuillez communiquer avec votre institution financière.', 
								'Transaction failure. Credit card declined by financial institution. Client should contact financial institution.'); 
...
INSERT INTO APP_MESSAGES ( APP_ROLE_ID, RESPONSE_CODE, RESPONSE_MESSAGE_EN, RESPONSE_MESSAGE_FR, RESPONSE_KB ) 
						VALUES ( 'AMDOCS_AGENT', '101', 
								...
								'Le paiement par carte de crédit ne peut pas être effectué. Veuillez vérifier les renseignements sur la carte de crédit. Si ces renseignements sont exacts, veuillez les faire suivre à l Équipe de prévention des sinistres.', 
								'Transaction failure. Credit card listed in negative database. Use Source form to send details to Loss Prevention.'); 
...
INSERT INTO APP_MESSAGES ( APP_ROLE_ID, RESPONSE_CODE, RESPONSE_MESSAGE_EN, RESPONSE_MESSAGE_FR, RESPONSE_KB ) 
						VALUES ( 'AMDOCS_AGENT', '102', 
								...
								'Le paiement par carte de crédit ne peut pas être effectué car il s agit d une carte de crédit internationale. Les cartes de crédit internationales doivent être préenregistrées pour pouvoir être utilisées.', 
								'Transaction failure. International credit card. Client must pre-register credit card w/Loss Prevention or use Canadian credit card.'); 
...
INSERT INTO APP_MESSAGES ( APP_ROLE_ID, RESPONSE_CODE, RESPONSE_MESSAGE_EN, RESPONSE_MESSAGE_FR, RESPONSE_KB ) 
						VALUES ( 'AMDOCS_AGENT', '103', 
								...
								'Le paiement par carte de crédit ne peut pas être effectué. Veuillez vérifier les renseignements sur la carte de crédit. Si ces renseignements sont exacts, veuillez consulter les mémos dans Knowbility.', 
								'Transaction failure. Credit card has exceeded maximum number of  transactions allowed by TELUS Mobility during a prescribed period.');
...
INSERT INTO APP_MESSAGES ( APP_ROLE_ID, RESPONSE_CODE, RESPONSE_MESSAGE_EN, RESPONSE_MESSAGE_FR, RESPONSE_KB ) 
   						VALUES ( 'AMDOCS_AGENT', '300', 
								...
								'Le paiement par carte de crédit ne peut pas être effectué car au moins un renseignement sur le client ne correspond pas au titulaire de la carte. Veuillez vérifier les détails sur le client et essayez de nouveau. Si vous obtenez encore ce message, veuillez consulter les mémos dans Knowbility.', 
								'Transaction failure.  AVS Mismatch. Billing address provided by client must match address on file with credit bureau.');  

INSERT INTO APP_MESSAGES ( APP_ROLE_ID, RESPONSE_CODE, RESPONSE_MESSAGE_EN, RESPONSE_MESSAGE_FR, RESPONSE_KB ) 
						VALUES ( 'AMDOCS_DEFAULT', '100', 
								'Sorry, we cannot process your credit card payment.  Please verify the credit card details you provided and try again.  If the problem persists, please contact your financial institution.', 
								'Désolés, votre paiement par carte de crédit ne peut pas être effectué. Veuillez vérifier less renseignements sur la carte de crédit et essayez de nouveau. Si le problème persiste, veuillez communiquer avec votre institution financière.', 
								'Transaction failure. Credit card declined by financial institution. Client should contact financial institution.'); 
