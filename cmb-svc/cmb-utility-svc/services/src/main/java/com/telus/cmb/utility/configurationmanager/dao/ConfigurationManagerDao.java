package com.telus.cmb.utility.configurationmanager.dao;
...
public interface ConfigurationManagerDao {

	  void loadProperties(ConfigurationInfo info) throws ApplicationException;
	  ...
	  int removeProperties(int configurationId) throws ApplicationException;
	  
	  int removePropertiesRecursively(int configurationId) throws ApplicationException;
	  
	  int removeConfiguration(int configurationId) throws ApplicationException;
	  
	  ConfigurationInfo newConfiguration(int parentConfigurationId, 
			  String name) throws ApplicationException;
	  
	  long getActivationLogID() throws ApplicationException;
	  
	  EquipmentChangeInfo getEquipmentChangeDetailsByESNs(String oldESN, 
			  String newESN) throws ApplicationException;
	  
	  void logActivation(com.telus.eas.config1.info.ActivationLogInfo 
			  pActivationLogInfo, long pActLogID) throws ApplicationException;
	  ...
	  void report_changeAddress(long transactionId, java.util.Date 
			  transactionDate, AddressInfo oldAddr, AddressInfo newAddr) throws ApplicationException;
	  
	  void report_subscriberNewCharge(long transactionId, java.util.Date 
			  transactionDate, String chargeCode, String waiverCode) throws ApplicationException;
	  
	  void report_changePaymentMethod(long transactionId, java.util.Date 
			  transactionDate, char oldPaymentMethod, char newPaymentMethod) throws ApplicationException ;
	  
	  void report_makePayment(long transactionId, java.util.Date 
			  transactionDate, char paymentMethod, double paymentAmount) throws ApplicationException ;
	  
	  void report_accountStatusChange(long transactionId, java.util.Date 
			  transactionDate, char oldHotlinedInd, char newHotlinedInd, 
			  char oldStatus, char newStatus, char statusFlag) throws ApplicationException ;
	  
	  void report_prepaidAccountTopUp(long transactionId, java.util.Date 
			  transactionDate, Double amount, char cardType, char topUpType) throws ApplicationException ;
	  ...
	  void report_changePhoneNumber(long transactionId, java.util.Date 
			  transactionDate, String oldPhoneNumber, String newPhoneNumber) throws ApplicationException;
	  ...
	  void report_subscriberChangeEquipment(long transactionId, java.util.Date transactionDate,
              SubscriberInfo subscriberInfo, EquipmentInfo oldEquipmentInfo,
              EquipmentInfo newEquipmentInfo,String dealerCode,String salesRepCode,
              String requestorId, String repairId,String swapType, EquipmentInfo associatedMuleEquipmentInfo,
