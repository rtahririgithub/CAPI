CREATE OR REPLACE PACKAGE CONEADM.CONTACT_EVENT_PKG AS
/******************************************************************************
   ...
   1.8        24/Sep/2013 Mahan Razagh  Added new procedure insertReplied_RawInboundSMS() 
******************************************************************************/
...
CREATE OR REPLACE PACKAGE BODY CONEADM.CONTACT_EVENT_PKG AS
...
(
    ...
    ,pi_contact_event_type_id     in number
     ,pi_chnl_org_id                 in contact_event_channel_org.contact_event_id%type
    ,pi_outlet_id                 in contact_event_outlet.contact_event_id%type
    ,pi_sales_rep_id             in contact_event_sales_rep.contact_event_id%type
    ,pi_user                     in varchar2
)
Is
Begin
