...
@DomainStrategy
public class SubscriberActivationStrategy {
	...
	public void activate(Subscriber subscriber) {
		...
		identityProfileService.registerConsumerProfile(subscriber, account, IdentityProfileRegistrationOrigin.SUBSCRIBER_CREATION);
	}
}
