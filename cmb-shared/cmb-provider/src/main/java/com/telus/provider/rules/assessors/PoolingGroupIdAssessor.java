...
public class PoolingGroupIdAssessor extends ConditionAssessor {
	
	public PoolingGroupIdAssessor(String conditionId) {
		super(conditionId);
	}
	...
	public ConditionResult evaluate(WorkingMemory workingMemory) throws TelusAPIException {		
		...
		if (oldResult != null && !poolingGroupIdElement.isModified()) {
		...
		ConditionResult result = new ConditionResult(RuleConstants.CONDITION_TYPE_TEXT, String.valueOf(poolingGroupId));
