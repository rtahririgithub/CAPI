...
import com.telus.api.account.PCSWesternPrepaidConsumerAccount;
...
public class TMPCSWesternPrepaidConsumerAccount extends TMPrepaidConsumerAccount implements PCSWesternPrepaidConsumerAccount {
  /**
   * @link aggregation
   */
  ...
  public TMPCSWesternPrepaidConsumerAccount(TMProvider provider, WesternPrepaidConsumerAccountInfo delegate, Equipment equipment) {
    super(provider, delegate, equipment);
    this.delegate = delegate;
    account = new TMPCSAccount(provider, delegate, this);
 }

  public TMPCSWesternPrepaidConsumerAccount(TMProvider provider, WesternPrepaidConsumerAccountInfo delegate) {
