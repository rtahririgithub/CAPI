...
@Deprecated
public class TMIDENPostpaidBusinessRegularAccount extends TMPostpaidBusinessRegularAccount implements IDENPostpaidBusinessRegularAccount {
  ...
  public TMIDENPostpaidBusinessRegularAccount(TMProvider provider, PostpaidBusinessRegularAccountInfo delegate) {
