...
public class TransactionTypeAssessor extends ConditionAssessor {
	
	public TransactionTypeAssessor(String conditionId) {
		super(conditionId);
	}
	...
	public ConditionResult evaluate(WorkingMemory workingMemory) throws TelusAPIException {		
		...
		if (oldResult != null && !transactionTypeElement.isModified()) {
		...
		ConditionResult result = new ConditionResult(RuleConstants.CONDITION_TYPE_TEXT, String.valueOf(transactionType));
