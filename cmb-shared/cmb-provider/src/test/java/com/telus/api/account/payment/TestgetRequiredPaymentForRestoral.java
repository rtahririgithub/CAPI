...
public class TestgetRequiredPaymentForRestoral extends BaseTest {
...
//			System.setProperty("cmb.services.ReferenceDataFacade.url","t3://localhost:8001");					
	...
	public TestgetRequiredPaymentForRestoral(String name) throws Throwable {
		super(name);
...
//		setupData("d3");
		...
		_testGetRequiredPaymentForRestoral_invalidTableError();
	 ...
	 * @throws Throwable
	 */
	public void _testGetRequiredPaymentForRestoral() throws Throwable {
		...
		try {
			...
			System.out
					.println("***** START OF TEST RUN testGetRequiredPaymentForRestoral****");
			...
			System.out
					.println("##### testGetRequiredPaymentForRestoral****");
	...
	public void _testGetRequiredPaymentForRestoral_invalidTableError() throws Throwable {
		...
		try {
			...
			PostpaidAccount  postpaidAccount  = (PostpaidAccount)api.getAccountManager().findAccountByPhoneNumber(subscriberId);
	...
	public void _testGetRequiredPaymentForRestoral_1() throws Throwable {
	...
	public void setupData(String env) {
    	...
    	if (env.equalsIgnoreCase("d1")) {
    		...
    		BAN = 70616563;
//    		subscriberId="5142931498";
//    		subscriberId="9055500027";//invalid table error
    		subscriberId="7781760104";
