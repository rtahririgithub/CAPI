 ...
 *
 */
public class AccountLifeCycleManagementExceptionTranslator extends DefaultExceptionTranslator {
	...
	public Exception translateException(Throwable cause, ExceptionTranslationContext context) {
		...
		if (cause instanceof TelusValidationException) {
			...
			return createServiceException(cause, ServiceErrorCodes.ERROR_DESC_APILINK_VALIDATION, id, context);
		}
