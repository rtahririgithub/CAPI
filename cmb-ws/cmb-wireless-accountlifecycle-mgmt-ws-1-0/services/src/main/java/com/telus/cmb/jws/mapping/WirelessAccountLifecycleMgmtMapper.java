...
public class WirelessAccountLifecycleMgmtMapper {
	...
	public static AuditMapper AuditMapper() {
		return AuditMapper.getInstance();
	}
	...
	public static class BaseWirelessAccountMapper extends AbstractSchemaMapper<BaseWirelessAccount, AccountInfo> {
		...
		private static BaseWirelessAccountMapper INSTANCE = null;
	...
	}// end of BaseWirelessAccountMapper
	...
	public static class AuditMapper extends AbstractSchemaMapper<AuditInfo, com.telus.eas.transaction.info.AuditInfo> {
		
		private static AuditMapper INSTANCE = null;

		private AuditMapper() {
			super(AuditInfo.class, com.telus.eas.transaction.info.AuditInfo.class);
		}
		
		protected synchronized static AuditMapper getInstance() {
			if (INSTANCE == null) {
				INSTANCE = new AuditMapper();
			}
			return INSTANCE;
		}
	...
	public static class CreatePostpaidAccountResponseMapper extends AbstractSchemaMapper<CreatePostpaidAccountResponse, PostpaidAccountCreationResponseInfo> {
		...
		private static CreatePostpaidAccountResponseMapper INSTANCE = null;
...
}// end of WirelessAccountLifecycleMgmtMapper
