...
@WebService(
		...
		serviceName = "BillingInquiryReferenceService_v2_1", 
		targetNamespace = "http://telus.com/wsdl/CMO/BillingInquiryMgmt/BillingInquiryReferenceService_2", 
		wsdlLocation = "/wsdls/BillingInquiryReferenceService_v2_1.wsdl", 
		endpointInterface = "com.telus.cmb.jws.BillingInquiryReferenceServicePort")
		
@BindingType("http://schemas.xmlsoap.org/wsdl/soap/http")
public class BillingInquiryReferenceService_21 extends BaseService implements BillingInquiryReferenceServicePort {
	public BillingInquiryReferenceService_21() {
	...
	/* (non-Javadoc)
	 * @see com.telus.cmb.jws.BillingInquiryReferenceServicePortType#getDiscountPlan(String)
	 */
	@ServiceBusinessOperation(errorCode="CMB_BIRS_0014")
	public DiscountPlanType getDiscountPlan(final String discountCode)
			throws PolicyException, ServiceException {
		return execute( new ServiceInvocationCallback<DiscountPlanType>() {
			@Override
			public DiscountPlanType doInInvocationCallback(
					ServiceInvocationContext context) throws Throwable {
				return new DiscountPlanTypeMapper().mapToSchema(getReferenceDataFacade(context).getDiscountPlan(discountCode));
			}
	...
	/* (non-Javadoc)
	 * @see com.telus.cmb.jws.BillingInquiryReferenceServicePortType#getDiscountPlanListByActiveInd
	 */
	@ServiceBusinessOperation(errorCode="CMB_BIRS_0015")
	public List<DiscountPlanType> getDiscountPlanListByActiveInd(
			final boolean activeInd) throws PolicyException, ServiceException {
		return execute( new ServiceInvocationCallback<List<DiscountPlanType>>() {

			@Override
			public List<DiscountPlanType> doInInvocationCallback(
					ServiceInvocationContext context) throws Throwable {
				return new DiscountPlanTypeMapper().mapToSchema(getReferenceDataFacade(context).getDiscountPlans(activeInd));
			}
	...
	/* (non-Javadoc)
	 * @see com.telus.cmb.jws.BillingInquiryReferenceServicePortType#getDiscountPlanListByPricePlan
	 */
	@ServiceBusinessOperation(errorCode="CMB_BIRS_0016")
	public List<DiscountPlanType> getDiscountPlanListByPricePlan(
			final String pricePlanCode, final ProvinceCode provinceCode, final int term,
			final Boolean activeInd) throws PolicyException, ServiceException {
		return execute( new ServiceInvocationCallback<List<DiscountPlanType>>() {
			...
			public List<DiscountPlanType> doInInvocationCallback(
					ServiceInvocationContext context) throws Throwable {
				return new DiscountPlanTypeMapper().mapToSchema(getReferenceDataHelper(context).retrieveDiscountPlans(activeInd, pricePlanCode, provinceCode.name(), term));
			}
		});
	}
