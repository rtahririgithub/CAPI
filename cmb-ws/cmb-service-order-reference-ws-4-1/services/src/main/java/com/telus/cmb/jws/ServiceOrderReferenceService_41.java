...
@WebService(
		...
		serviceName = "ServiceOrderReferenceService_v4_1", 
		targetNamespace = "http://telus.com/wsdl/SMO/OrderMgmt/ServiceOrderReferenceService_4",
		wsdlLocation = "/wsdls/ServiceOrderReferenceService_v4_1.wsdl", 
		endpointInterface = "com.telus.cmb.jws.ServiceOrderReferenceServicePort")
		
@BindingType("http://schemas.xmlsoap.org/wsdl/soap/http")
public class ServiceOrderReferenceService_41 extends BaseService implements ServiceOrderReferenceServicePort {
	/* (non-Javadoc)
