...
@WebService(
		...
		serviceName = "SubscriberLifeCycleManagementService_v1_0", 
		targetNamespace = "http://telus.com/wsdl/CMO/OrderMgmt/SubscriberLifeCycleManagementService_1", 
		wsdlLocation = "/wsdls/SubscriberLifeCycleManagementService_v1_0.wsdl", 
		endpointInterface = "com.telus.cmb.jws.SubscriberLifeCycleManagementServicePort")
		
@BindingType("http://schemas.xmlsoap.org/wsdl/soap/http")

public class SubscriberLifeCycleManagementService_10 extends BaseService implements SubscriberLifeCycleManagementServicePort{
