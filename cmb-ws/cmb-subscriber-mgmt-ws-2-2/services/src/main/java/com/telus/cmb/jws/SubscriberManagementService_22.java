...
@WebService(
		...
		serviceName = "SubscriberManagementService_v2_2", 
		targetNamespace = "http://telus.com/wsdl/CMO/OrderMgmt/SubscriberManagementService_2", 
		wsdlLocation = "/wsdls/SubscriberManagementService_v2_2.wsdl", 
		endpointInterface = "com.telus.cmb.jws.SubscriberManagementServicePort")
		
@BindingType("http://schemas.xmlsoap.org/wsdl/soap/http")

public class SubscriberManagementService_22 extends BaseService implements SubscriberManagementServicePort {
	
	public SubscriberManagementService_22() {
