...
import com.telus.cmb.jws.mapper.DepositHistoryMapper;
...
import com.telus.cmb.jws.GetDepositHistory;
import com.telus.cmb.jws.GetDepositHistoryResponse;
...
@WebService(portName = "AccountInformationHistoryServicePort", serviceName = "AccountInformationHistoryService_v1_1", 
		targetNamespace = "http://telus.com/wsdl/CMO/InformationMgmt/AccountInformationHistoryService_1", 
		wsdlLocation = "/wsdls/AccountInformationHistoryService_v1_1.wsdl", 
		endpointInterface = "com.telus.cmb.jws.AccountInformationHistoryServicePort")
		@BindingType("http://schemas.xmlsoap.org/wsdl/soap/http")                      
		public class AccountInformationHistoryService_11 extends BaseServiceV2 implements AccountInformationHistoryServicePort {

	private static final int MAX_OCCUR = 1000;

	public AccountInformationHistoryService_11() {
	...
	@ServiceBusinessOperation(errorCode = "CMB_AHS_0004", errorMessage = "Get Account Deposit History error")
	@Override
	public GetDepositHistoryResponse getDepositHistory(final GetDepositHistory request) throws ServiceException {
		return execute(new ServiceInvocationCallback<GetDepositHistoryResponse>() {
			@Override
			public GetDepositHistoryResponse doInInvocationCallback(ServiceInvocationContext context) throws Throwable {
				GetDepositHistoryResponse ret = new GetDepositHistoryResponse();
				if (context.getSchemaValidationException() != null) {
					return schemaValidationErrorToResponse(ret, context.getSchemaValidationException());
				}

				int ban = new Integer(request.getBillingAccountNumber());
				DepositHistoryInfo[] depositHistoryList = getAccountInformationHelper(context).retrieveDepositHistory(ban, request.getFromDate(), request.getToDate());
				ret.getDepositHistoryList().addAll(DepositHistoryMapper.getInstance().mapToSchema(depositHistoryList));
				return ret;
			}
		});
	}

/*	@ServiceBusinessOperation(errorCode = "CMB_AHS_0005", errorMessage = "Ping error")
	@Override
	public com.telus.tmi.xmlschema.xsd.enterprise.basetypes.types.ping_v2.PingResponse ping(com.telus.tmi.xmlschema.xsd.enterprise.basetypes.types.ping_v2.Ping parameters) throws ServiceException {
		...
		try {
			...
			pingStats.setServiceName("AccountInformationHistoryService 1.1");
		}
	...
	public com.telus.tmi.xmlschema.xsd.enterprise.basetypes.types.ping_v1.PingResponse ping(com.telus.tmi.xmlschema.xsd.enterprise.basetypes.types.ping_v1.Ping parameters) throws ServiceException {
		...
		response.setVersion("AccountInformationHistoryService 1.1");
		return response;
	}
