...
public class EndpointConfiguration extends ConfigurationSupport {
	...
	@Bean
	public Object subscriberLifecycleManager() {
		return simpleRemoteStatelessSessionProxy("SubscriberLifecycleManager#com.telus.cmb.subscriber.lifecyclemanager.svc.SubscriberLifecycleManager", 
				SubscriberLifecycleManager.class, getValue("services/SubscriberLifecycleManager/url"), "ejb_user", "ejb_user");
	}
