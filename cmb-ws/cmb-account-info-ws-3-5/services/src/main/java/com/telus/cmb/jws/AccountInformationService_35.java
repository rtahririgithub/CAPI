...
import com.telus.cmb.jws.mapper.AccountInformationServiceMapper.MaxVoipLineBaseMapper;
import com.telus.cmb.jws.mapper.AccountInformationServiceMapper.MaxVoipLineMapper;
import com.telus.cmb.jws.mapper.AccountInformationServiceMapper.PersonalCreditInformationMapper;
import com.telus.cmb.jws.mapper.AccountInformationServiceMapper.PhoneNumberSearchOptionMapper;
...
@WebService(portName = "AccountInformationServicePort", serviceName = "AccountInformationService_v3_5", 
		targetNamespace = "http://telus.com/wsdl/CMO/InformationMgmt/AccountInformationService_3", 
		wsdlLocation = "/wsdls/AccountInformationService_v3_5.wsdl", 
		endpointInterface = "com.telus.cmb.jws.AccountInformationServicePort")
		@BindingType("http://schemas.xmlsoap.org/wsdl/soap/http")
public class AccountInformationService_35 extends BaseService implements AccountInformationServicePort {
	
	private static final int RETURN_MAXIMUM = 1000;
	private static final CreditCardMapper ccMapper = new CreditCardMapper();

	public AccountInformationService_35() {
	...
	private MaxVoipLineMapper getMaxVoipLineMapper() {
		return AccountInformationServiceMapper.MaxVoipLineMapper();
	}
	
	private MaxVoipLineBaseMapper getMaxVoipLineBaseMapper() {
		return AccountInformationServiceMapper.MaxVoipLineBaseMapper();
	}
	
	private PhoneNumberSearchOptionMapper getPhoneNumberSearchOptionMapper() {
		return AccountInformationServiceMapper.PhoneNumberSearchOptionMapper();
	}
	...
	/**
	 * Get account by billing account number
	 * @param ban the billing account number
	 * @return the account object
	 * For TELUS consumer accounts, clientConsentIndicatorCode will not return a correct value due to CMP project change in Oct 2016.
	 * To retrieve correct preference setting please call ECPMS service with a valid UUID for all TELUS consumer accounts.
	 */
	@Override
	...
	public Account getAccountByAccountNumber(final String ban) throws PolicyException, ServiceException {
		...
		return execute( new ServiceInvocationCallback<Account>() {
			...
			public Account doInInvocationCallback(ServiceInvocationContext context) throws Throwable {				
				return getAccountMapper().mapToSchema(getAccountInformationHelper(context).retrieveHwAccountByBan(Integer.valueOf(ban)));
			}
		});
	}

	/**
	 * Get a list of accounts by billing account numbers
	 * @param banNumbers the list of billing account numbers
			...
			public List<Account> doInInvocationCallback(ServiceInvocationContext context) throws Throwable {
				...
				if (banNumbers != null && banNumbers.size() > 0) {
					for (int i = 0; i < (banNumbers.size() <= RETURN_MAXIMUM ? banNumbers.size() : RETURN_MAXIMUM); i++) {
						...
						try {
							Account account = getAccountMapper().mapToSchema(getAccountInformationHelper(context).retrieveHwAccountByBan(Integer.valueOf(ban)));
							accountList.add(account);
						} catch (ApplicationException ae) {
							// BAN not found error will not be thrown
							if (!StringUtils.equalsIgnoreCase(ae.getErrorCode(), "APP10004")) {
								throw ae;
							}
						}
					}
	...
	public void updateEmailAddress(final String ban, final String emailAddress,Boolean notificationSuppressionInd, AuditInfo auditInfo) throws PolicyException, ServiceException {
	...
	public InvoicePropertyListType getInvoicePropertyList(final String ban) throws PolicyException, ServiceException {
		
		return execute(new ServiceInvocationCallback<InvoicePropertyListType>() {
			
			@Override
			public InvoicePropertyListType doInInvocationCallback(ServiceInvocationContext context) throws Throwable {
	 ...
	 * Get account by IMSI
	 * @param imsi the IMSI
	 * @return a list which contains a single account object if found; otherwise, an empty list
	 * For TELUS consumer accounts, clientConsentIndicatorCode will not return a correct value due to CMP project change in Oct 2016.
	 * To retrieve correct preference setting please call ECPMS service with a valid UUID for all TELUS consumer accounts.
	 */
	@Override
	...
	public List<com.telus.tmi.xmlschema.xsd.customer.basetypes.accountinformationtypes_v2.Account> getAccountListByIMSI(final String imsi) throws PolicyException, ServiceException {
		...
		return execute(new ServiceInvocationCallback<List<com.telus.tmi.xmlschema.xsd.customer.basetypes.accountinformationtypes_v2.Account>>() {
			...
			public List<Account> doInInvocationCallback(ServiceInvocationContext context) throws Throwable {
				...
				List<AccountInfo> accountInfoList = getAccountInformationHelper(context).retrieveAccountListByImsi(imsi);
				List<Account> accounts = null;
				if(accountInfoList !=null && accountInfoList.isEmpty() == false){
					 accounts = getAccountMapper().mapToSchema(accountInfoList);
				}
				return accounts;
			}
		});
	...
	public void updateContactInformation(final String billingAccountNumber, final ContactPropertyListType contactPropertyList, Boolean notificationSuppressionInd, AuditInfo auditInfo)
			throws PolicyException, ServiceException {
	...
	public PersonalCreditInformation getPersonalCreditInformation(final String billingAccountNumber) throws PolicyException, ServiceException {
	...
	public BusinessCreditInformation getBusinessCreditInformation(final String billingAccountNumber) throws PolicyException, ServiceException {
	...
	public UpdatePaymentMethodResponse updatePaymentMethod(final UpdatePaymentMethod parameters, final OriginatingUserType updatePaymentMethodInSoapHdr) throws PolicyException, ServiceException {
		...
		return execute(new ServiceInvocationCallback <UpdatePaymentMethodResponse>() {
			...
			public UpdatePaymentMethodResponse doInInvocationCallback(ServiceInvocationContext context) throws Throwable {
				...
				if (creditCardValidationType.isValidateCreditCardInd()) {
					CreditCardTransactionInfo creditCardTransactionInfo = createCreditCardTransactionInfo(updatePaymentMethodInSoapHdr, paymentMethodInfo.getCreditCard0(),
							creditCardValidationType.getBusinessRole().toString());
				...
				getAccountLifecycleFacade(context).updatePaymentMethod(Integer.parseInt(billingAccountNumber), null, paymentMethodInfo, notificationSuppressionInd, auditInfo,
	...
	public RegisterTopUpCreditCardResponse registerTopUpCreditCard(final RegisterTopUpCreditCard parameters, final OriginatingUserType registerTopUpCreditCardInSoapHdr)
			throws PolicyException, ServiceException {
	...
	public void removeTopUpCreditCard(String billingAccountNumber) throws PolicyException, ServiceException {
		// TODO Implementation at a later date
		throw new ServicePolicyException(ServiceErrorCodes.ERROR_UNSUPPORTED_OPERATION, "This operation is not yet implemented.");
	}
	...
	public void createFollowUp(final String billingAccountNumber, final FollowUpRequest followUp, final boolean asyncInd) throws PolicyException, ServiceException {
	...
	public void getSubscriberEligibilitySupportingInfo(String billingAccountNumber, List<String> memoTypeList, Date dateFrom, Date dateTo, Holder<List<Memo>> memoList,
			Holder<String> totalPaymentAmount, Holder<String> totalDepositHeld) throws PolicyException, ServiceException {
		// TODO Implementation at a later date
		throw new ServicePolicyException(ServiceErrorCodes.ERROR_UNSUPPORTED_OPERATION, "This operation is not yet implemented.");
	}
	...
	/**
	 * Get a list of CustomerNotificationPreferenceType by billing account number
	 * For TELUS consumer accounts, clientConsentIndicatorCode will not return a correct value due to CMP project change in Oct 2016.
	 * To retrieve correct preference setting please call ECPMS service with a valid UUID for all TELUS consumer accounts.
	 * @param billingAccountNumber the billing account number
	 * @return a list of CustomerNotificationPreferenceType
	 */
	@Override
	@ServiceBusinessOperation(errorCode = "CMB_AIS_0025", errorMessage = "Get Customer Notification Preference List error")
	public List<CustomerNotificationPreferenceType> getCustomerNotificationPreferenceList(final String billingAccountNumber) throws PolicyException, ServiceException {
		...
		return execute(new ServiceInvocationCallback<List<CustomerNotificationPreferenceType>>() {
			...
			public List<CustomerNotificationPreferenceType> doInInvocationCallback(ServiceInvocationContext context) throws Throwable {
				...
				if (billingAccountNumber != null && billingAccountNumber.length() > 0) {
					...
					List<CustomerNotificationPreferenceInfo> preferenceList = getAccountLifecycleManager(context).getCustomerNotificationPreferenceList(ban, context.getAccountLifeCycleManagerSessionId());
    ...
    public ResponseMessage updateCustomerNotificationPreferenceList(final String billingAccountNumber, final List<CustomerNotificationPreferenceUpdateType> notificationPreferenceList)
    		throws PolicyException, ServiceException {
	...
	private void updateCustomerNotificationPreferenceList(String billingAccountNumber, List<CustomerNotificationPreferenceUpdateType> notificationPreferenceList, ServiceInvocationContext context)
			throws Throwable {
		...
		if (billingAccountNumber != null 
			...
			getAccountLifecycleManager(context).updateCustomerNotificationPreferenceList(Integer.valueOf(billingAccountNumber).intValue(), customerNotificationPreferenceInfos,
	 ...
	 * @param phoneNumberSearchOption the phone number search option
	 * @return the account object
	 * For TELUS consumer accounts, clientConsentIndicatorCode will not return a correct value due to CMP project change in Oct 2016.
	 * To retrieve correct preference setting please call ECPMS service with a valid UUID for all TELUS consumer accounts.
	 */
	@Override
	@ServiceBusinessOperation(errorCode = "CMB_AIS_0027", errorMessage = "Get Account By Phone Number failed")
	public Account getAccountByPhoneNumber(final String phoneNumber, final PhoneNumberSearchOption phoneNumberSearchOption) throws PolicyException, ServiceException {
		...
		return execute(new ServiceInvocationCallback<Account>() {
			...
			public Account doInInvocationCallback(ServiceInvocationContext context) throws Throwable {
				...
				AccountInfo accountInfo = getAccountInformationHelper(context).retrieveHwAccountByPhoneNumber(phoneNumber, phoneNumberSearchOptionInfo);
	...
	@Override
	@ServiceBusinessOperation(errorCode = "CMB_AIS_0028", errorMessage = "Get Next Seat Group Id failed")
	public String getNextSeatGroupId() throws PolicyException, ServiceException {
		
		return execute( new ServiceInvocationCallback<String>() {
			
			@Override
			public String doInInvocationCallback(ServiceInvocationContext context) throws Throwable {
				return getAccountInformationHelper(context).getNextSeatGroupId();
			}
		});
	}
	
	@Override
	@ServiceBusinessOperation(errorCode = "CMB_AIS_0029", errorMessage = "Get Max Voip Line List failed")
	public List<MaxVoipLineType> getMaxVoipLineList(final String ban, final Long subscriptionId) throws PolicyException, ServiceException {
		
		return execute(new ServiceInvocationCallback<List<MaxVoipLineType>>() {
			
			@Override
			public List<MaxVoipLineType> doInInvocationCallback(ServiceInvocationContext context) throws Throwable {
				
				@SuppressWarnings("unchecked")
				List<MaxVoipLineInfo> maxVoipLineList = getAccountInformationHelper(context).getMaxVoipLineList(Integer.valueOf(ban), subscriptionId);
				if (maxVoipLineList.isEmpty()) {
					throw new ServicePolicyException(ServiceErrorCodes.ERROR_DESC_NO_DATA_FOR_BAN_SUBSCRIBER, "No MaxVoipLine records found for ban = " + ban + " and subscriptionId = " + subscriptionId);
				}
				
				return getMaxVoipLineMapper().mapToSchema(maxVoipLineList);
			}
		});
	}

	@Override
	@ServiceBusinessOperation(errorCode = "CMB_AIS_0030", errorMessage = "Create Max Voip Line List failed")
	public void createMaxVoipLine(final MaxVoipLineBaseType maxVoipLineBaseType) throws PolicyException, ServiceException {
		...
		execute(new ServiceInvocationCallback<Object>() {
			...
			public Object doInInvocationCallback(ServiceInvocationContext context) throws Throwable {
				...
				MaxVoipLineInfo info = getMaxVoipLineBaseMapper().mapToDomain(maxVoipLineBaseType);
				getAccountInformationHelper(context).createMaxVoipLine(info);
	...
	@Override
	@ServiceBusinessOperation(errorCode = "CMB_AIS_0031", errorMessage = "Update Max Voip Line List failed")
	public void updateMaxVoipLineList(final List<MaxVoipLineBaseType> maxVoipLineBaseTypeList) throws PolicyException, ServiceException {
		...
		execute(new ServiceInvocationCallback<Object>() {
			...
			public Object doInInvocationCallback(ServiceInvocationContext context) throws Throwable {
				...
				List<MaxVoipLineInfo> maxVoipLineList = getMaxVoipLineBaseMapper().mapToDomain(maxVoipLineBaseTypeList);
				getAccountInformationHelper(context).updateMaxVoipLine(maxVoipLineList);
