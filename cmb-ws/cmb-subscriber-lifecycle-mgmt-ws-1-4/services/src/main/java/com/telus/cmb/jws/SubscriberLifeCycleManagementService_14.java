...
@WebService(
		...
		serviceName = "SubscriberLifeCycleManagementService_v1_4", 
		targetNamespace = "http://telus.com/wsdl/CMO/OrderMgmt/SubscriberLifeCycleManagementService_1", 
		wsdlLocation = "/wsdls/SubscriberLifeCycleManagementService_v1_4.wsdl", 
		endpointInterface = "com.telus.cmb.jws.SubscriberLifeCycleManagementServicePort")
		
@BindingType("http://schemas.xmlsoap.org/wsdl/soap/http")

public class SubscriberLifeCycleManagementService_14 extends BaseService implements SubscriberLifeCycleManagementServicePort{
	...
	private XMLGregorianCalendar getXMLGregorianCalendarNow() throws DatatypeConfigurationException {
		...
		XMLGregorianCalendar currentXMLDate = datatypeFactory.newXMLGregorianCalendar(gregorianCalendar);
