...
@WebService(
		...
		serviceName = "ServiceOrderReferenceService_v4_2", 
		targetNamespace = "http://telus.com/wsdl/SMO/OrderMgmt/ServiceOrderReferenceService_4",
		wsdlLocation = "/wsdls/ServiceOrderReferenceService_v4_2.wsdl", 
		endpointInterface = "com.telus.cmb.jws.ServiceOrderReferenceServicePort")
		
@BindingType("http://schemas.xmlsoap.org/wsdl/soap/http")
public class ServiceOrderReferenceService_42 extends BaseService implements ServiceOrderReferenceServicePort {
	/* (non-Javadoc)
