...
import com.telus.tmi.xmlschema.xsd.service.basetypes.serviceorderreferencetypes_v5.PricePlan;
...
public class PricePlanMapper extends ReferenceMapper<PricePlan, PricePlanInfo> {
	...
	protected PricePlan performSchemaMapping(PricePlanInfo source, PricePlan target) {
		...
		target.setWaiveActivationFeeInd(source.waiveActivationFee());
		
		target.setOfferInd(source.isSelectedOffer());
