...
import com.telus.cmb.jws.ResetCscSubscriptionResponseType;
...
@WebService(
		...
		serviceName = "SubscriberManagementService_v3_1", 
		targetNamespace = "http://telus.com/wsdl/CMO/OrderMgmt/SubscriberManagementService_3", 
		wsdlLocation = "/wsdls/SubscriberManagementService_v3_1.wsdl", 
		endpointInterface = "com.telus.cmb.jws.SubscriberManagementServicePort")		
@BindingType("http://schemas.xmlsoap.org/wsdl/soap/http")
public class SubscriberManagementService_31 extends BaseServiceV2 implements SubscriberManagementServicePort {
	
	public SubscriberManagementService_31() {
	...
	public ResetCscSubscriptionResponseType resetCscSubscription(final SubscriberData subscriberData) throws ServiceException {
		...
		return execute(new ServiceInvocationCallback<ResetCscSubscriptionResponseType>() {
			...
			public ResetCscSubscriptionResponseType doInInvocationCallback(ServiceInvocationContext context) throws Throwable {
				...
				ResetCscSubscriptionResponseType response = new ResetCscSubscriptionResponseType();
					...
					int ban = Integer.valueOf(subscriberData.getBillingAccountNumber());
					String subscriberId = subscriberData.getSubscriberId();
					String productType = null;
					if (subscriberData.getProductType() != null) {
						productType = subscriberData.getProductType();
					}
	...
	public String ping() throws ServiceException {
		return "SubscriberManagementService 3.1";
	}
