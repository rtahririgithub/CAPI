...
import com.telus.cmb.jws.BusinessRegistrationType;
...
public class WirelessAccountLifecycleMgmtMapper {
	...
	public static BusinessRegistrationMapper BusinessRegistrationMapper() {
		return BusinessRegistrationMapper.getInstance();
	}
	...
	public static class BusinessRegistrationMapper extends AbstractSchemaMapper<BusinessRegistrationType, BusinessRegistrationInfo> {

		private static BusinessRegistrationMapper INSTANCE;

		private BusinessRegistrationMapper() {
			super(BusinessRegistrationType.class, BusinessRegistrationInfo.class);
		}

		protected synchronized static BusinessRegistrationMapper getInstance() {
			if (INSTANCE == null) {
				INSTANCE = new BusinessRegistrationMapper();
			}
			return INSTANCE;
		}

		@Override
		protected BusinessRegistrationInfo performDomainMapping(BusinessRegistrationType source, BusinessRegistrationInfo target) {
			target.setBusinessRegistrationNumber(source.getRegistrationNum());
			target.setBusinessRegistrationType(source.getRegistrationTypeCd());
			return super.performDomainMapping(source, target);
		}
