...
@WebService(portName = "BillingInquiryServicePort", 
			serviceName = "BillingInquiryService_v1_2", 
			targetNamespace = "http://telus.com/wsdl/CMO/BillingInquiryMgmt/BillingInquiryService_1", 
			wsdlLocation = "/wsdls/BillingInquiryService_v1_2.wsdl", 
			endpointInterface = "com.telus.cmb.jws.BillingInquiryServicePort")

@BindingType("http://schemas.xmlsoap.org/wsdl/soap/http")

public class BillingInquiryService_12 extends BaseService  implements BillingInquiryServicePort {
	...
	public BillingInquiryService_12() {
	...
	public void recordPayment(final String ban, final String amount, final CreditCard creditCard, final PaymentType paymentType, final PaymentSourceType paymentSourceType,
		...
		execute(new ServiceInvocationCallback<Object>() {
			...
			public Object doInInvocationCallback(ServiceInvocationContext context) throws Throwable {
				recordPayment(context, getCreditCardPaymentInfo(creditCard), ban, amount, paymentType, paymentSourceType, notificationSuppressionInd, null);
				return null;
			}
		});
	}
	...
	public List<ChargesAndAdjustmentsId> applyChargesAndAdjustmentsToAccount(final List<ChargeAndAdjustment> chargesAndAdjustmentsList)
			throws PolicyException, ServiceException {
	...
	public List<ChargesAndAdjustmentsId> applyChargesAndAdjustmentsToAccountForSubscriber(final List<ChargeAndAdjustmentForSubscriber> chargesAndAdjustmentsForSubscriberList) throws PolicyException, ServiceException {
