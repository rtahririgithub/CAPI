...
public class ConfigurationManagerImplTest {
	...
	public void report_accountStatus() throws Throwable {
		...
		Date transactionDate = getDateInput(2010-1900, 10, 21);
	...
	public void report_changeAddress() throws Throwable {
		long transactionId = 69020;
		Date transactionDate = getDateInput(2006, 0, 01);
		AddressInfo oldAddr = new AddressInfo();
		AddressInfo newAddr = new AddressInfo();

		oldAddr.setStreetNumber("100");
	...
	public void report_changePaymentMethod() throws Throwable {
		long transactionId = 69020;
		Date transactionDate = getDateInput(2010-1900, 10, 21);
		char oldPaymentMethod = 'C';
		char newPaymentMethod = 'R';
	...
	public void report_changePhoneNumber() throws Throwable {
		long transactionId = 69020;
		Date transactionDate =getDateInput(2010-1900, 10, 21);
		String oldPhoneNumber = "4167654321";
		String newPhoneNumber = "4161234567";
	...
	public void report_changePricePlan() throws Throwable {
		long transactionId = 69020;
		Date transactionDate = getDateInput(2010-1900, 9, 21);
		String oldPlan = "PCS25MPTC";
		String newPlan = "PTLK75CF";
	...
	public void getInteractionDetails() throws Throwable {
		...
		int ban = 2790733;
		Date from = getDateInput(2001-1900, 9, 21);
		Date to = getDateInput(2010-1900, 10, 21);
		String type = null;
