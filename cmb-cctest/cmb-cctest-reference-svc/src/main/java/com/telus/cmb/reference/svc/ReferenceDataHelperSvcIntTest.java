...
public abstract class ReferenceDataHelperSvcIntTest{
...
//	}
	 ...
	 */
	@Test
	public void testRetrieveNumberGroupListByProvince() throws Exception {
		...
		NumberGroupInfo[] ngInfoList= service.retrieveNumberGroupListByProvince(accountType, accountSubTypeType, productType, equipmentType, provinceCode);
		...
		System.out.println("SIZE: "+ngInfoList.length);
		for(int i=0;i<ngInfoList.length;i++){
			NumberGroupInfo	ngInfo=(NumberGroupInfo) ngInfoList[i];
